...
Here’s the canonical, up-to-date way to run the monarch-tools in your current setup.
	
		
## 1. Activate monarch-tools module
...
## 3. Run categorize
- Run the script that does a first pass at assigning categories to transactions and launches interactive mode. You need four input files:

	* Transactions text file (from extract command)
